...
namespace ID3.ID3v2Frames.TextFrames
{
    ...
    public abstract class TextOnlyFrame : Frame
    {
        ...
        /// <summary>
        /// 判断当前Frame是否含有有用的数据 (Text!=null,Empty)
        /// </summary>
    ...
    /// Class Description: 提供编码支持的文本Frame类
    /// </summary>
    public class TextFrame : TextOnlyFrame
    {
        /*
         * 注：这个类同时兼容支持URL和文字框架 
         * 两种类型的区别: URL frame不包含TextEncoding同时永远使用Ascii作为编码
         * TextFrames包括编码
         * ID3.ORG:
        ...
        public override MemoryStream FrameStream(int MinorVersion)
        {
            ...
            if (!IsUrl)
            {
                ...
                //   SetEncoding();
                TextEncoding = TextEncodings.UTF_16;
                //No Anto Encoding !!!!!!!!!!???????????

                ms.WriteByte((byte)TextEncoding); // Write Text Encoding
                WriteText(ms, Text, TextEncoding, false); // Write Text
            }
            else
        ...
        public override int Length
        {
            get
            {
                ...
                return (1 + GetTextLength(Text, TextEncodings.UTF_16, false)); //!!!!!!!!!!!!!
            }
        }
        ...
        public override int Length
        {
            get
            {
                ...
                //if (ID3v2.AutoTextEncoding)
                    ...
                    TextEncoding = TextEncodings.UTF_16;
                //一律UTF-16 歌词部分
                //理论上应该不用加这段代码的，但是莫名其妙下面的Encoding就会变成ASCII
                ...
                return 1 + TextLen + /*GetTextLength(_Description, TextEncoding, false)*/ 2;
            }
        }
    ...
    public class TextWithLanguageFrame : UserTextFrame
    {
            ...
            : base(FrameID, Flags)
        {
            ...
            _Description = Data.ReadTextEx(Length, TextEncoding, ref Length, true);
        ...
        public override MemoryStream FrameStream(int MinorVersion)
        {
            ...
            //WriteText(ms, _Description, TextEncodings.Ascii, true);
            WriteText(ms, "", TextEncodings.Ascii, true);
            WriteText(ms, "", TextEncodings.Ascii, true); //Replace _Description with "00 00"
            //2011年3月16日 22:26:37 Give Description In
