namespace zlib
{
    ...
    internal sealed class StaticTree
    {
        static StaticTree()
        {
            ...
            StaticTree.static_l_desc = new StaticTree(StaticTree.static_ltree, Tree.extra_lbits, 0x101, StaticTree.L_CODES, 15);
            StaticTree.static_d_desc = new StaticTree(StaticTree.static_dtree, Tree.extra_dbits, 0, 30, 15);
            StaticTree.static_bl_desc = new StaticTree(null, Tree.extra_blbits, 0, 0x13, 7);
        }
