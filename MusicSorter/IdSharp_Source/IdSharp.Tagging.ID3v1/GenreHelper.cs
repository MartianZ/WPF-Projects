namespace IdSharp.Tagging.ID3v1
{
    ...
    public static class GenreHelper
    {
        static GenreHelper()
        {
            GenreHelper.m_GenreByIndex = new string[] { 
                ...
                "Classical", "Instrumental", "Acid", "House", "Game", "Sound Clip", "Gospel", "Noise", "Alt. Rock", "Bass", "Soul", "Punk", "Space", "Meditative", "Instrumental Pop", "Instrumental Rock", 
                "Ethnic", "Gothic", "Darkwave", "Techno-Industrial", "Electronic", "Pop-Folk", "Eurodance", "Dream", "Southern Rock", "Comedy", "Cult", "Gangsta Rap", "Top 40", "Christian Rap", "Pop/Funk", "Jungle", 
                ...
                "Folk", "Folk/Rock", "National Folk", "Swing", "Fast-Fusion", "Bebob", "Latin", "Revival", "Celtic", "Bluegrass", "Avantgarde", "Gothic Rock", "Progressive Rock", "Psychedelic Rock", "Symphonic Rock", "Slow Rock", 
        ...
        {
            for (int num1 = 0; num1 <= 0x93; num1++)
            {
                if (genre == GenreHelper.m_GenreByIndex[num1])
                {
                    return num1;
                }
            }
        ...
        public static string[] GenreByIndex
        {
            get
            {
                return GenreHelper.m_GenreByIndex;
            }
        }


        private static readonly string[] m_GenreByIndex;
    }
}
